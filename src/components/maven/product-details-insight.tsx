          ...
          <div className="flex justify-center w-full">
            ...
            >
              <div className="md:pt-6 flex space-y-6 md:space-y-0 flex-col-reverse md:flex-row-reverse justify-between lg:min-h-[360px] items-start">
                <motion.div
                  className="pl-2 md:px-2 flex flex-col space-y-4 lg:justify-start h-full w-full lg:max-w-[350px]"
                  variants={itemVariants}
                >
                  ...
                  <div className="w-full flex items-center justify-center md:justify-start py-[20px] space-x-2 md:space-x-4">
                    <TooltipProvider>
                      <Tooltip delayDuration={100}>
                        <TooltipTrigger asChild>
                          <Button
                            variant={"outline"}
                            size={"sm"}
                            className="rounded-3xl h-12 md:h-9 text-md px-6 md:px-4 font-normal bg-[#1A1A1D] dark:bg-background text-white hover:border-[#1A1A1D]"
                      ...
                      <Tooltip delayDuration={100}>
                        <TooltipTrigger asChild>
                          ...
                          >
                            <Button
                              variant={"ghost"}
                              className="h-12 md:size-9 rounded-full group text-black/60 dark:text-white/60 hover:text-purple-500"
                              onClick={() => {
                ...
                >
                  <div className="pb-7 lg:pb-0 flex flex-col px-2">
              ...
              <AnimatePresence mode="wait">
                {open && (
                  ...
                  >
                    ...
                    <motion.div
                      className="flex flex-col px-0 md:px-4 pb-4"
                      variants={itemVariants}
                    >
                      <div className="">
                        <div className="mb-3">
                        ...
                        <div className="flex justify-center">
                          <div className="pt-0 space-y-3 w-[400px] md:w-full">
                            {/* Main Video Player */}
                            <motion.div
                            ...
                            {/* Video Thumbnails */}
                            <motion.div
                              className="flex gap-2 overflow-x-auto pb-2 justify-start"
