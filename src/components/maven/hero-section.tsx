  ...
  return (
    ...
    >
      <Button
        size="lg"
        variant={variant}
        className={`font-medium rounded-full relative overflow-hidden ${className}`}
      >
        <Link href={href}>
          <motion.span
            className="relative z-10 block"
            animate={{
              y: isHovered ? [0, -2, 0] : 0, // Changed from x to y movement
            }}
            transition={{
              duration: 0.5,
              ease: "easeInOut",
        ...
        {variant === "default" && (
          <motion.div
            ...
            initial={{ y: "100%" }} // Changed from x to y
            animate={{
              y: isHovered ? 0 : "100%", // Changed from x to y
            }}
            transition={{
              duration: 0.3,
              ease: "easeInOut",
