              ...
              <g clipPath="url(#cs_clip_1_moon-8)">
                ...
                <g mask="url(#cs_mask_1_moon-8)">
                  ...
                  <g filter="url(#filter0_f_748_4488)">
                    <path
                      d="M212.25-20H100v139.75h112.25V-20z"
                      fill="#18A0FB"
                    />
            ...
            <Accordion type={"multiple"} className="w-full">
              ...
              <AccordionItem value="item-5">
                ...
                <AccordionContent className="font-[family-name:var(--font-khand)] text-xl">
                  ...
                  <p>
                    No system is entirely secure. While we strive to protect
              ...
              <AccordionItem value="item-7">
                ...
                <AccordionContent className="font-[family-name:var(--font-khand)] text-xl">
                  ...
                  <ul className="list-disc pl-6 mt-2 space-y-1">
                    ...
                    <li>
                      <strong>Opt-Out</strong>: Discontinue use of the App if
                      you do not agree with this policy.
                    </li>
                  </ul>
                </AccordionContent>
              </AccordionItem>
